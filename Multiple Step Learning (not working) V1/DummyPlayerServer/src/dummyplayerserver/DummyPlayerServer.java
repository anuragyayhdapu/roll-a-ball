...
//                    }
//                    if (n == 103) 
                    x0 = x50;       // store previous value of x50 in x0
                    x50 = x;        // store value of 50th frame in x50
                    ...
                    if (loop < 1) {
                        if (n % 50 == 0) {
                            ...
                            Map.Entry<Integer, Integer> l = Less_force.floorEntry(x50 - x0);
                            Map.Entry<Integer, Integer> u = More_force.ceilingEntry(x50 - x0);
